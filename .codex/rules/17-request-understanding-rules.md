# Request Understanding Rules

- identify the real requested outcome before choosing an implementation path
- separate the user goal from the first apparent technical solution
- extract constraints explicitly: stack, architecture, quality level, deadlines, scope boundaries, and whether the task is scaffold, production, or exploratory
